    ...
    try:
        if os.path.exists(cred_location):
            try:
                ...
                logger.info(e)
                update.reply_text(f"Error : `{e}` occured!\n\n<b>.Maybe because there is some error in your `mega.ini` file! Please send your file, exatly as mentioned in the readme 👉Downloading your file now without logging in to your account...</i>", disable_web_page_preview=True)
